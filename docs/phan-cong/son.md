...
| Cloud Firestore | `AccountRepository`, `ChildProfileRepository`, `ContentRepository`, `ActivityAttemptRepository` | Lưu tài khoản, hồ sơ trẻ, cài đặt, nội dung màu sắc và kết quả |
