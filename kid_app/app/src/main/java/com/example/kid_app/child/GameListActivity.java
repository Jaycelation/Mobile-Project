...
/**
 * GameListActivity — Placeholder cho module Trò chơi (Bước 6).
 *
 * Bước 5: chỉ hiển thị placeholder đẹp.
 * Bước 6: sẽ thêm danh sách game + mini-game mẫu.
 */
public class GameListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lấy thông tin từ intent để hiển thị đúng
